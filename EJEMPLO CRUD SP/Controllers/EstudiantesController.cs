...
namespace EJEMPLO_CRUD_SP.Controllers
{
    public class EstudiantesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdEstudiante,Nombre,Apellido,FechaNacimiento,Direccion")] Estudiante estudiante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEstudiante,Nombre,Apellido,FechaNacimiento,Direccion")] Estudiante estudiante)
        {
