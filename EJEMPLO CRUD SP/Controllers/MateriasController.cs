...
namespace EJEMPLO_CRUD_SP.Controllers
{
    public class MateriasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdMateria,NombreMateria,Descripcion")] Materia materia)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdMateria,NombreMateria,Descripcion")] Materia materia)
        {
